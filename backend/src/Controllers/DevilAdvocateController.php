...
class DevilAdvocateController {
    ...
    public function run(Request $req): array {
        ...
        $contextDoc     = (new PromptBuilder())->prepareContextDocumentForPrompt($this->docRepo->findBySession($sessionId));
        ...
        $debateBody = "Based on this debate context:\n\n{$messagesSummary}\n\nProvide your strongest counterargument.";
        $userContent = (new EvidencePromptBuilder())->buildDevilAdvocateUserMessage(
            $debateBody,
            $evidenceReport,
            $contextDoc
        );

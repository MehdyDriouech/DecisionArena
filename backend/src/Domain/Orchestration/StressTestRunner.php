            ...
            foreach ($agentsForRound as $agentId) {
                ...
                try {
                    ...
                    $routed  = $this->providerRouter->chat(
                        ...
                        RunTimeoutPolicy::routerOptionsForTelemetry($sessionId, 'stress-test', $phase, $agentId, $round, null)
                    );
                ...
                if ($this->daTriggerPolicy->shouldTrigger(
                    ...
                    try {
                        ...
                        $daRouted  = $this->providerRouter->chat(
                            ...
                            null,
                            null,
                            RunTimeoutPolicy::routerOptionsForTelemetry($sessionId, 'stress-test', 'devil-advocate', 'devil_advocate', $round, null)
                        );

            ...
            foreach ($agentsForRound as $agentId) {
                ...
                try {
                    ...
                    $routed  = $this->providerRouter->chat(
                        ...
                        RunTimeoutPolicy::routerOptionsForTelemetry($sessionId, 'decision-room', $phase, (string)$agentId, $round, null)
                    );
                ...
                if ($this->daTriggerPolicy->shouldTrigger(
                    ...
                    try {
                        ...
                        $daRouted  = $this->providerRouter->chat(
                            ...
                            null,
                            null,
                            RunTimeoutPolicy::routerOptionsForTelemetry($sessionId, 'decision-room', 'devil-advocate', 'devil_advocate', $round, null)
                        );
            ...
            foreach ($selectedAgents as $agentId) {
                ...
                try {
                    ...
                    $routed = $this->providerRouter->chat(
                        ...
                        null,
                        $this->resolveAgentOverride($agentProviders, (string)$agentId),
                        RunTimeoutPolicy::routerOptionsForTelemetry($sessionId, 'decision-room', 'retry-round', (string)$agentId, $rounds + 1, null)
                    );

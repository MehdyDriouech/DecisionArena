  ...
  const detail = (() => {
      ...
      <div class="card sc-express-summary" style="padding:14px 16px;margin-bottom:14px;background:rgba(16,185,129,0.06);border:1px solid rgba(16,185,129,0.22);">
        ...
        <div style="display:grid;gap:10px;">
          ...
          <div style="font-size:11px;color:var(--text-muted);">
            ${escHtml(t('contexts.express.lastMemory'))}: ${lastWhen}${shortMid ? ` · <code>${escHtml(shortMid)}</code>` : ''}
          </div>
    ...
    return `
      ...
      <div class="card" style="padding:16px 18px;">
        ...
        ${isDeleteConfirm ? `
          <div class="card" style="margin-top:12px;padding:12px 14px;border-color:rgba(239,68,68,0.45);background:rgba(239,68,68,0.06);">
